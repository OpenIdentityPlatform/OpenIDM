...
public class DisruptorShortPublisher implements PluggablePublisher {
    ...
    static Disruptor<DisruptorShortEventEntry> disruptor =
            new Disruptor<DisruptorShortEventEntry>(DisruptorShortEventEntry.EVENT_FACTORY, executor,
...
//        disruptor.handleEventsWith(new StatisticsHandler(disruptor));
    ...
    public final EventEntry start(Name eventName, Object payload, Object context) {
        ...
        final DisruptorShortEventEntry eventEntry = ringBuffer.get(sequence);
