...
define([
    ...
    "text!templates/admin/mapping/PropertiesTemplate.html",
    "text!templates/admin/mapping/PropertyMappingDialogAddTemplate.html",
    "text!templates/admin/mapping/PropertyMappingDialogEditTemplate.html"
],function () {
    var staticFiles = [
                       "templates/admin/mapping/MappingTemplate.html",
                       "templates/admin/mapping/PropertiesTemplate.html",
                       "templates/admin/mapping/PropertyMappingDialogAddTemplate.html",
                       "templates/admin/mapping/PropertyMappingDialogEditTemplate.html"
                   ],
                   deps = arguments;
