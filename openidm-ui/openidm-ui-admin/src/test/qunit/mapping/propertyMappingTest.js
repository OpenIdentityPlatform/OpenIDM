        ...
        executeAll: function (server) {
            ...
            QUnit.asyncTest("PropertiesView Tests", function () {
                ...
                AttributesGridView.render([mappingName], function () {
                    ...
                    sinon.stub(UIUtils, "jqConfirm", function (message,callback) {
                        callback();
            ...
            QUnit.asyncTest("AddPropertyMappingDialog Tests", function () {
                ...
                EventManager.sendEvent(Constants.EVENT_CHANGE_VIEW, { route: Router.configuration.routes.propertiesView, args: [mappingName] }).always(function () {

                    //addPropertyMappingDialog tests
                    addPropertyMappingDialog.render({
                        saveCallback: function(mappingProperties){
                            QUnit.equal(_.last(mappingProperties).target,"test","Property mapping successfully added");
