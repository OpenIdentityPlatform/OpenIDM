...
define([
    ...
    QUnit.test("convertFromIntervalString", function () {
        ...
        QUnit.equal(convertedValue.start, '04/25/2016 7:00:00 AM', "startDate is correct");
        QUnit.equal(convertedValue.end, '04/30/2016 7:00:00 AM', "endDate is correct");
    });
    ...
    QUnit.test("convertFromIntervalString with timezone offset", function () {
        ...
        QUnit.equal(convertedValue.start, '04/25/2016 12:00:00 AM', "startDate is correct");
        QUnit.equal(convertedValue.end, '04/30/2016 12:00:00 AM', "endDate is correct");
    });

    QUnit.test("convertToIntervalString", function () {
        var startDate = "04/25/2016 7:00:00 AM",
            endDate = "04/30/2016 7:00:00 AM",
    ...
    QUnit.test("convertToIntervalString with timezone offset", function () {
        var startDate = "04/25/2016 12:00:00 AM",
            endDate = "04/30/2016 12:00:00 AM",
