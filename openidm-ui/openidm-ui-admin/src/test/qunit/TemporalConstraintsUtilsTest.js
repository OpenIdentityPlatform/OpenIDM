...
define([
    ...
    QUnit.test("convertFromIntervalString", function () {
        var intervalString = "2016-04-25T07:00:00.000Z/2016-04-30T07:00:00.000Z",
            convertedValue = TemporalConstraintsUtils.convertFromIntervalString(intervalString);
    ...
    QUnit.test("convertToIntervalString", function () {
        var startDate = "04/25/2016 12:00:00 AM",
            ...
            intervalString = TemporalConstraintsUtils.convertToIntervalString(startDate, endDate);
