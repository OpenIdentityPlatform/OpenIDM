define([
    ...
    QUnit.test("Get the index of the OPENAM module", function(assert) {
        var view = new AuthenticationAbstractView,
            authModulesIndexFirst,
            authModulesIndexMiddle,
            authModulesIndexLast,
            authModulesIndexNone;
        ...
        assert.equal(view.getAMModuleIndex(authModulesIndexFirst), 0, "Properly detects when the AM Modules is in the first position.");
        ...
        assert.equal(view.getAMModuleIndex(authModulesIndexMiddle), 1, "Properly detects when the AM Modules is in the middle position.");
        ...
        assert.equal(view.getAMModuleIndex(authModulesIndexLast), 2, "Properly detects when the AM Modules is in the last position.");
        ...
        assert.equal(view.getAMModuleIndex(authModulesIndexNone), -1, "Properly detects when the AM Modules is not included in the data set.");
