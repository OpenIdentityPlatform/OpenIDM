...
define("org/forgerock/openidm/ui/admin/sync/SituationalScriptsView", [
    "org/forgerock/openidm/ui/admin/sync/MappingScriptsView"
], function(MappingScriptsView) {
    var SituationalScriptsView = MappingScriptsView.extend({
    ...
    return new SituationalScriptsView();
});
