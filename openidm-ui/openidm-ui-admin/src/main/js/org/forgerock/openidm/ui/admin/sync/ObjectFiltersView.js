...
define("org/forgerock/openidm/ui/admin/sync/ObjectFiltersView", [
    "org/forgerock/openidm/ui/admin/sync/MappingScriptsView"
], function(MappingScriptsView) {
    var ObjectFiltersView = MappingScriptsView.extend({
        ...
        model: {
            scripts: ["validSource", "validTarget"],
            scriptEditors: {},
            successMessage: "objectFiltersSaveSuccess"
        },
