...
define([
    ...
    var AuthenticationModuleDialogView = AuthenticationAbstractView.extend({
                ...
                .done(_.bind(function(resources, view) {
                    ...
                    this.parentRender(() => {
                        ...
                        BootstrapDialog.show({
                            title: prefix + " " + this.model.readableName + " " + $.t("templates.auth.modules.authFieldsetName"),
        ...
        getModuleView: function(moduleName) {
            ...
            require(["org/forgerock/openidm/ui/admin/authentication/modules/" + moduleName],
                (result) => {
