    ...
    var authenticationDataChanges = {},
        ...
        AuthenticationAbstractView = AdminAbstractView.extend({
            ...
            partials: [
                ...
                "partials/authentication/_customProperties.html",
                "partials/authentication/_augmentSecurityContext.html",
                "partials/authentication/_propertyMapping.html"
            ],
            events: {
            ...
            removeLogoutURL: function() {
                return ConfigDelegate.patchEntity({"id": "ui/configuration"}, [{
                    "field": "/configuration/logoutUrl",
                    "operation": "remove"
                }]);
            },

            saveLogoutURL: function(logoutURL) {
                return ConfigDelegate.patchEntity({"id": "ui/configuration"}, [{
                    "field": "/configuration/logoutUrl",
                    "operation": "replace",
                    "value": logoutURL
            ...
            // Search for an OPENID_CONNECT module w/ resolve[0] name of OPENAM
            getAMModuleIndex: function(allAuthModules) {
                return _.findIndex(allAuthModules, function(module) {
                    let nameMatch = module.name === "OPENID_CONNECT";
                    let resolverNameMatch = _.get(module.properties, "resolvers[0].name") === "OPENAM";
