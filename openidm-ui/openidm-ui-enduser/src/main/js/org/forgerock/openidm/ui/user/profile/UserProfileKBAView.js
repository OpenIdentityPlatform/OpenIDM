...
define([
    ...
    var UserProfileSocialKBAView = AbstractView.extend({
        partials: UserProfileKBAView.partials.concat([
            "partials/_socialIdentities.html"
        ]),

        parentRender: function (callback) {
            UserProfileKBAView.parentRender.call(this, function () {
    ...
    UserProfileSocialKBAView.prototype = _.extend(Object.create(UserProfileKBAView), UserProfileSocialKBAView.prototype);

    return new UserProfileSocialKBAView();
});
