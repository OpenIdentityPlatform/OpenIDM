...
package org.forgerock.openidm.rest2ldap.internal.metadata;
...
import org.forgerock.openidm.rest2ldap.internal.Rest2LdapComponent;
...
public class ConfigMeta implements MetaDataProvider {
     ...
     * {@link org.forgerock.openidm.rest2ldap.internal.metadata.ConfigMeta}.
     */
    ...
    static {
        List<JsonPointer> p = new ArrayList<JsonPointer>(1);
        p.add(new JsonPointer("/authentication/password"));
    ...
    public List<JsonPointer> getPropertiesToEncrypt(String pidOrFactory, String instanceAlias,
        ...
        if (Rest2LdapComponent.PID.equalsIgnoreCase(pidOrFactory)) {
