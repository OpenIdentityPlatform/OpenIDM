...
@References({
    ...
    @Reference(name = "IDMConnectionFactoryReference", referenceInterface = IDMConnectionFactory.class,
            ...
            cardinality = ReferenceCardinality.OPTIONAL_UNARY, policy = ReferencePolicy.DYNAMIC),
    @Reference(name = "GroovyScriptEngineFactoryReference",
            target = "(org.forgerock.script.enginename=GroovyEngine)",
            referenceInterface = ScriptEngineFactory.class, bind = "addingEntries",
            unbind = "removingEntries", cardinality = ReferenceCardinality.MANDATORY_UNARY,
            policy = ReferencePolicy.STATIC),
    @Reference(name = "JavascriptScriptEngineFactoryReference",
            target = "(org.forgerock.script.enginename=JavascriptEngine)",
            referenceInterface = ScriptEngineFactory.class, bind = "addingEntries",
            unbind = "removingEntries", cardinality = ReferenceCardinality.MANDATORY_UNARY,
            policy = ReferencePolicy.STATIC),
