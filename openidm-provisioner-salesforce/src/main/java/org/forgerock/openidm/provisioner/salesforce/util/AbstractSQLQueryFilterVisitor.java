...
public abstract class AbstractSQLQueryFilterVisitor<R extends SQLRenderer, P> implements QueryFilterVisitor<R, P, JsonPointer> {
     ...
     * {@inheritDoc}
     */
    public abstract R visitAndFilter(final P parameters, List<QueryFilter<JsonPointer>> subFilters);

    /*
     * {@inheritDoc}
     */
    public abstract R visitOrFilter(final P parameters, List<QueryFilter<JsonPointer>> subFilters);
