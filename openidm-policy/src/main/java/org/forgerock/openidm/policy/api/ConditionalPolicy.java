 ...
 */
@Title("Conditional Policy")
public class ConditionalPolicy {

    private ConditionalPolicy() {
        // hidden constructor
    }
    ...
    @Description("Required Field-Names in Object-to-Validate")
    public List<String> dependencies;

    @Description("Object-to-Validate (only in object-validation responses)")
    @ReadOnly
    public Object fullObject;

    @Description("Condition Script")
    @NotNull
