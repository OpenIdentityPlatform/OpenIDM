...
//@Test(groups = {"OrigMyTestGroup"})
public abstract class RepoServiceFunctionalTestBase {
    ...
    public RepoServiceFunctionalTestBase(final String idmRootDir, final String configDir, final String dbType) {
        this.idmRootDir = idmRootDir;
...
//    @Test(inheritGroups=true) //groups = {testGroup/*"repo"*/})
