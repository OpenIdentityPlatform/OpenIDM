 ...
 */
package org.forgerock.openidm.repo.dynamodb.internal.metadata;

import org.forgerock.json.fluent.JsonPointer;
import org.forgerock.json.fluent.JsonValue;
import org.forgerock.openidm.metadata.MetaDataProvider;
import org.forgerock.openidm.metadata.MetaDataProviderCallback;
import org.forgerock.openidm.repo.dynamodb.internal.DynamoDBRepoService;
...
public class ConfigMeta implements MetaDataProvider {
    ...
    public List<JsonPointer> getPropertiesToEncrypt(String pidOrFactory, String instanceAlias,
            JsonValue config) {
        if (DynamoDBRepoService.PID.equals(pidOrFactory)) {
