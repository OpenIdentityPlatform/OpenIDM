...
define(["jquery", "underscore", "dimple", "org/forgerock/openidm/ui/common/dashboard/widgets/AbstractWidget", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openidm/ui/common/delegates/SystemHealthDelegate"], function ($, _, dimple, AbstractWidget, eventManager, constants, conf, SystemHealthDelegate) {
    var widgetInstance = {},
        ...
        drawChart: function drawChart(svg, data, percent) {
            var ring,
            ...
            this.$el.find(".widget-header").html('<div class="header">' + $.t("dashboard.used") + '</div>' + '<div class="percent ' + percentClass + '">' + percent + '</div>');
