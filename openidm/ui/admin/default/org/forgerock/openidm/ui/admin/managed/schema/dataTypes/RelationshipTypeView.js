...
define(["jquery", "underscore", "handlebars", "jsonEditor", "backbone", "backgrid", "org/forgerock/openidm/ui/admin/util/BackgridUtils", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/admin/managed/schema/dataTypes/EditResourceCollectionDialog", "org/forgerock/openidm/ui/admin/managed/schema/util/SchemaUtils"], function ($, _, handlebars, JSONEditor, Backbone, Backgrid, BackgridUtils, AdminAbstractView, EditResourceCollectionDialog, SchemaUtils) {
    ...
    var RelationshipTypeView = AdminAbstractView.extend({
        ...
        model: {},
        partials: ["partials/managed/schema/_refPropertiesNewRow.html", "partials/managed/schema/_refPropertiesEditableRow.html"],
        /**
        ...
        */
        render: function render(args, callback) {
            ...
            this.parentRender(function () {
                _this.loadPropertiesGrid();
                _this.loadResourceCollectionGrid();
                if (callback) {
                    callback();
                }
            });
        ...
        */
        ...
        loadPropertiesGrid: function loadPropertiesGrid() {
            ...
            var self = this,
                ...
                propertiesGrid,
                refProperties = _.reject(this.data.currentValue.properties._refProperties.properties, function (refProp) {
                return refProp.propertyName === "_id";
            }),
                makeSortable = function makeSortable() {
                BackgridUtils.sortable({
                    "containers": [_this2.$el.find(".refPropertiesList tbody")[0]],
        ...
        */
        addNewRefProperty: function addNewRefProperty(e) {
        ...
        */
        saveEditRefProperty: function saveEditRefProperty(e) {
            var row = $(e.target).closest("tr"),
        ...
        */
        cancelEditRefProperty: function cancelEditRefProperty(e) {
            e.preventDefault();
            this.getValue();
            this.render();
        },
        ...
        */
        loadResourceCollectionGrid: function loadResourceCollectionGrid() {
            var self = this,
                cols = [{
                name: "label",
                label: "Label",
        ...
        addNewResourceCollection: function addNewResourceCollection(e) {
