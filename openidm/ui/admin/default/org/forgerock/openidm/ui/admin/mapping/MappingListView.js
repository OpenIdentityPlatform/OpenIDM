...
define(["jquery", "underscore", "handlebars", "backbone", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/delegates/ReconDelegate", "org/forgerock/commons/ui/common/util/DateUtil", "org/forgerock/openidm/ui/admin/delegates/SyncDelegate", "org/forgerock/openidm/ui/admin/util/ConnectorUtils", "org/forgerock/commons/ui/common/util/UIUtils", "backgrid", "org/forgerock/openidm/ui/admin/util/BackgridUtils", "org/forgerock/commons/ui/common/util/AutoScroll", "dragula", "org/forgerock/openidm/ui/admin/mapping/util/MappingUtils"], function ($, _, handlebars, Backbone, AdminAbstractView, eventManager, configDelegate, constants, reconDelegate, dateUtil, syncDelegate, connectorUtils, UIUtils, Backgrid, BackgridUtils, AutoScroll, dragula, mappingUtils) {
    ...
    var MappingListView = AdminAbstractView.extend({
        ...
        syncNow: function syncNow(e) {
            ...
            reconDelegate.triggerRecon(mappingName, true, function (runningRecon) {
                _this3.updateMappingRecon(mappingName, runningRecon);
            }, 2000).then(function (completedRecon) {
                _this3.toggleReconButtons(mappingName);
                _this3.updateMappingRecon(mappingName, completedRecon);
            });
        },
        /**
        ...
        updateReconStatus: function updateReconStatus(mappingName, runningReconId) {
            ...
            reconDelegate.waitForAll([runningReconId], true, function (runningRecon) {
                _this4.updateMappingRecon(mappingName, runningRecon);
            }, 2000).then(function (completedRecon) {
                _this4.toggleReconButtons(mappingName);
                _this4.updateMappingRecon(mappingName, completedRecon[0]);
            });
        },
        /**
         * This function finds the appropriate mapping name based on the click event,
        ...
        stopSync: function stopSync(e) {
            ...
            reconDelegate.stopRecon(mapping.recon._id, true).then(function (canceledRecon) {
                ...
                _this5.updateMappingRecon(mappingName, canceledRecon);
            });
        }
    });
