    ...
    var EditManagedView = AbstractManagedView.extend({
        ...
        managedRender: function managedRender(callback) {
            this.parentRender(_.bind(function () {
                ...
                var formattedProps = _.map(_.get(this.data.currentManagedObject, "schema.properties.preferences.properties"), function (property, key) {
                    return {
                        "key": key,
        ...
        getManagedPreferences: function getManagedPreferences() {
            var preferences = {};

            _.each(this.data.preferencesSchema.getValue(), function (item) {
        ...
        saveManagedPreferences: function saveManagedPreferences(event) {
            this.saveManagedObject(this.data.currentManagedObject, this.data.managedObjects);
        },
