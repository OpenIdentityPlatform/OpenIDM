...
define(["jquery", "underscore", "org/forgerock/openidm/ui/admin/util/FilterEditor", "org/forgerock/openidm/ui/admin/delegates/ScriptDelegate"], function ($, _, FilterEditor, ScriptDelegate) {
    var tagMap = {
        "equalityMatch": "eq",
        "greaterOrEqual": "ge",
        "lessOrEqual": "le",
