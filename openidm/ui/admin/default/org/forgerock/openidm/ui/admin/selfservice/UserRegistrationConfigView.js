...
define(["jquery", "lodash", "handlebars", "form2js", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/openidm/ui/admin/delegates/SiteConfigurationDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/AdminUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/selfservice/SelfServiceStageDialogView", "org/forgerock/openidm/ui/common/delegates/SocialDelegate", "org/forgerock/openidm/ui/admin/mapping/properties/AttributesGridView", "org/forgerock/openidm/ui/common/util/oAuthUtils", "bootstrap-tabdrop"], function ($, _, handlebars, form2js, AdminAbstractView, ConfigDelegate, SiteConfigurationDelegate, UiUtils, AdminUtils, EventManager, Constants, SelfServiceStageDialogView, SocialDelegate, AttributesGridView, OAuthUtils) {
    ...
    var UserRegistrationConfigView = AdminAbstractView.extend({
        ...
        partials: ["partials/_toggleIconBlock.html", "partials/selfservice/_advancedoptions.html", "partials/_alert.html"],
        model: {
        ...
        render: function render(args, callback) {
            ...
            $.when(this.getResources(), ConfigDelegate.readEntity("selfservice.propertymap"), ConfigDelegate.readEntity("ui/configuration"), ConfigDelegate.readEntityAlways(this.model.configUrl), ConfigDelegate.readEntityAlways("external.email"), SocialDelegate.providerList()).then(_.bind(function (resources, propertyMap, uiConfig, selfServiceConfig, emailConfig, availableProviders) {
        ...
        showDetailDialog: function showDetailDialog(event) {
            ...
            if ($(event.target).parents(".checkbox").length === 0 && cardDetails.editable === "true") {
                if (cardDetails.type === "userDetails") {
                    _.each(this.model.saveConfig.stageConfigs, function (stage) {
                        if (stage.name === "userDetails") {
                            ...
                            currentData.identityServiceOptions = _this2.model.resources;
                        }
                    });
         ...
         */
        showHideEmailWarning: function showHideEmailWarning(stageConfigs, emailServiceAvailable) {
        ...
        */
        ...
        switchToUserDetails: function switchToUserDetails(registrationConfig) {
            registrationConfig.stageConfigs[0].name = "userDetails";

            ConfigDelegate.updateEntity("selfservice/registration", registrationConfig).then(function () {
