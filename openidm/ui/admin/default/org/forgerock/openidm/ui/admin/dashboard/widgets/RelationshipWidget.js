...
define(["jquery", "underscore", "bootstrap", "selectize", "d3", "org/forgerock/openidm/ui/common/dashboard/widgets/AbstractWidget", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate"], function ($, _, bootstrap, selectize, d3, AbstractWidget, ResourceDelegate) {
    var widgetInstance = {},
         ...
         */
        setupRelationshipChart: function setupRelationshipChart(details) {
            var _this = this,
        ...
        typeMouseOver: function typeMouseOver() {
         ...
         */
        dataTypeToggle: function dataTypeToggle() {
        ...
        typeMouseOut: function typeMouseOut() {
            var thisObject = d3.select(this),
                typeValue = thisObject.attr("type_value"),
        ...
        nodeMouseOver: function nodeMouseOver() {
            var thisObject = d3.select(this),
                typeValue = thisObject.attr("type_value"),
                strippedTypeValue = typeValue.replace(/ /g, "_"),
                focalNode = "mainNode",
        ...
        nodeMouseOut: function nodeMouseOut() {
            var thisObject = d3.select(this),
                typeValue = thisObject.attr("type_value"),
                colorValue = thisObject.attr("color_value"),
                strippedTypeValue = typeValue.replace(/ /g, "_"),
        ...
        updateRoundChart: function updateRoundChart(focalNode, nodeSet, linkSet, selectString) {
            ...
            }).on("mouseover", _this.nodeMouseOver).on("mouseout", _this.nodeMouseOut).call(force.drag);
            ...
            }).on('mouseover', _this.typeMouseOver).on("mouseout", _this.typeMouseOut);
            ...
            }).style("fill", "Black").style("font", "normal 12px Arial").on('mouseover', _this.typeMouseOver).on("mouseout", _this.typeMouseOut);
        }
    });
