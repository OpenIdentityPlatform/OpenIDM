...
define(["jquery", "lodash", "bootstrap", "handlebars", "form2js", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/util/AdminUtils", "bootstrap-dialog", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/xml/xml", "libs/codemirror/addon/display/placeholder"], function ($, _, boostrap, handlebars, form2js, AdminAbstractView, UiUtils, AdminUtils, BootstrapDialog, codeMirror) {

    var SelfServiceStageDialogView = AdminAbstractView.extend({
        element: "#dialogs",
        noBaseTemplate: true,
        events: {},
        partials: ["partials/selfservice/_emailValidation.html", "partials/selfservice/_kbaStage.html", "partials/selfservice/_userDetails.html", "partials/selfservice/_captcha.html", "partials/selfservice/_translationMap.html", "partials/selfservice/_translationItem.html", "partials/selfservice/_termsAndConditions.html", "partials/form/_basicInput.html", "partials/form/_basicSelectize.html", "partials/form/_tagSelectize.html"],
        model: {
            codeMirrorConfig: {
                lineNumbers: true,
                autofocus: false,
                ...
                _this.dialog = BootstrapDialog.show({
                    ...
                    onshown: _.bind(function (dialogRef) {
                        ...
                        _.each(dialogRef.$modalBody.find(".email-message-code-mirror-disabled"), function (instance) {
                            codeMirror.fromTextArea(instance, _.extend({ readOnly: true, cursorBlinkRate: -1 }, _this2.model.codeMirrorConfig));
                        });
                        ...
                        dialogRef.$modalBody.on("click", ".translationMapGroup button.add", { currentStageConfig: args.data }, _.bind(this.addTranslation, this));

                        dialogRef.$modalBody.on("click", ".translationMapGroup button.delete", { currentStageConfig: args.data }, _.bind(this.deleteTranslation, this));

                        dialogRef.$modalBody.on("keyup", ".translationMapGroup .newTranslationLocale, .translationMapGroup .newTranslationText", { currentStageConfig: args.data }, _.bind(this.checkAddTranslation, this));
                    }, _this),
                    buttons: [{
        ...
        addTranslation: function addTranslation(e) {
            ...
            if (!_.has(currentStageConfig[field][locale.val()])) {
                ...
                if (useCodeMirror) {
                    codeMirror.fromTextArea(translationMapGroup.find(".email-message-code-mirror-disabled:last")[0], _.extend({ readOnly: true, cursorBlinkRate: -1 }, this.model.codeMirrorConfig));
