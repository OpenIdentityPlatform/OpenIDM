...
define(["jquery", "underscore", "handlebars", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/mapping/util/MappingUtils", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/util/AdminUtils"], function ($, _, Handlebars, ConnectorDelegate, ConfigDelegate, UIUtils, MappingUtils, eventManager, ResourceDelegate, constants, AdminUtils) {
    ...
    obj.deleteConnector = function (connectorName, connectorPath, successCallback) {
        ...
        $.when(connectorMappingsPromise, partialPromise).then(function (connectorMappings) {
