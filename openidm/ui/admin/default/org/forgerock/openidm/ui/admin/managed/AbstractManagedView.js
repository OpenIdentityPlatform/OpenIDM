...
define(["jquery", "underscore", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/admin/delegates/RepoDelegate", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openidm/ui/admin/managed/schema/SchemaEditorView"], function ($, _, AdminAbstractView, ConfigDelegate, EventManager, Constants, RepoDelegate, Router, SchemaEditorView) {
    ...
    var AbstractManagedView = AdminAbstractView.extend({
        ...
        handlePreferences: function handlePreferences(managedObject) {
            var preferencesTabValue, preferencesIndex, fullPreferencesSchema;
            /**
