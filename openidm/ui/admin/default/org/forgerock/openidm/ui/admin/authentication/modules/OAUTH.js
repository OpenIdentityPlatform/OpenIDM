...
define(["jquery", "lodash", "form2js", "org/forgerock/openidm/ui/admin/authentication/AuthenticationAbstractView", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/xml/xml"], function ($, _, Form2js, AuthenticationAbstractView, codemirror) {

    var OpenIDConnectView = AuthenticationAbstractView.extend({
        template: "templates/admin/authentication/modules/OAUTH.html",

        knownProperties: AuthenticationAbstractView.prototype.knownProperties.concat(["authTokenHeader", "authResolverHeader", "resolvers"]),
