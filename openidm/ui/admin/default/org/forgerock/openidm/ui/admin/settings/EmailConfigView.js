...
define(["jquery", "underscore", "form2js", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/main/ValidatorsManager"], function ($, _, form2js, AdminAbstractView, eventManager, constants, ConfigDelegate, validatorsManager) {
    ...
    var EmailConfigView = AdminAbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            ConfigDelegate.readEntity("external.email").then(_.bind(function (data) {
