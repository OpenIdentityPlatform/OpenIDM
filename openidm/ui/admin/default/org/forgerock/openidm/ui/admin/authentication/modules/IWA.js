...
define(["jquery", "lodash", "form2js", "org/forgerock/openidm/ui/admin/authentication/AuthenticationAbstractView"], function ($, _, Form2js, AuthenticationAbstractView) {
    ...
    var IWAView = AuthenticationAbstractView.extend({
        ...
        knownProperties: AuthenticationAbstractView.prototype.knownProperties.concat(["servicePrincipal", "keytabFileName", "kerberosRealm", "kerberosServerName", "groupComparisonMethod"]),
