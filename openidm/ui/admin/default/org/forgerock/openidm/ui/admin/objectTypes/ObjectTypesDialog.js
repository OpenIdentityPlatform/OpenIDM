...
define(["jquery", "underscore", "jsonEditor", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/ValidatorsManager", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/admin/delegates/ConnectorDelegate", "bootstrap-dialog"], function ($, _, JSONEditor, AbstractView, validatorsManager, conf, eventManager, constants, uiUtils, ConnectorDelegate, BootstrapDialog) {
    var ObjectTypesDialog = AbstractView.extend({
        ...
        render: function render(defaultObjectType, selectedObjectType, connectorDetails, callback) {
            var _this = this;
         ...
         */
        saveObjectType: function saveObjectType() {
         ...
         */
        newObjectType: function newObjectType() {
         ...
         */
        get_OT_format: function get_OT_format(objectType) {
         ...
         */
        get_JE_format: function get_JE_format(key) {
        ...
        loadObjectTypeData: function loadObjectTypeData(objectTypes) {
            var JE_format;
