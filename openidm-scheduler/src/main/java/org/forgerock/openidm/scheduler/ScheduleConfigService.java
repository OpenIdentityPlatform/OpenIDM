...
//
//    // Optional user defined name for this newBuilder, derived from the file install name
...
//        logger.debug("Activating Service with configuration {}", compContext.buildServiceProperties());
//
...
//        } else {
//            jobName = (String) compContext.buildServiceProperties().get(Constants.SERVICE_PID);
//        }
//
...
//        configFactoryPID = (String) compContext.buildServiceProperties().get("config.factory-pid");
