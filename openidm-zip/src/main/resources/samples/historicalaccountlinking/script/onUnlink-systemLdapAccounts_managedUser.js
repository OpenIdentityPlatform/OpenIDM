...
var ref = mappingConfig.source + "/" + sourceId,
    historicalAccountsCollection = "managed/user/" + targetId + "/historicalAccounts",
    query = {
...
if (typeof queryResult !== 'undefined' && queryResult !== null) {
    ...
    if (typeof account !== 'undefined' && account !== null) {
        ...
        logger.debug("Updating historical account relationship for " + ref + " on managed user " + targetId);
