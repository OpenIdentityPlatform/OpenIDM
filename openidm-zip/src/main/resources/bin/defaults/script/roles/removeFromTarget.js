...
/*
 * This script removes an attribute value from the target attribute and returns the new target attribute value
 * 
...
removeValues(targetObject, attributeName, attributeValue);
