...
import static org.forgerock.openidm.crypto.CryptoConstants.ALGORITHM_SHA_512;

/**
 * This class defines a field storage scheme based on the 512-bit SHA-2 algorithm defined in FIPS 180-2.
 */
public class SaltedSHA512FieldStorageScheme extends FieldStorageSchemeImpl {
    ...
    public SaltedSHA512FieldStorageScheme() throws Exception {
        super(SHA512_LENGTH, ALGORITHM_SHA_512);
    }
}