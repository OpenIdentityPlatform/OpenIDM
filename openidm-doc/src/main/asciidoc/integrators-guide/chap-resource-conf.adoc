...
* The `bundleVersion : 2.0.0.0` must be exactly the same as the version of the CSV connector that you are using. If you specify a range here, the CSV connector version must be included in this range.
