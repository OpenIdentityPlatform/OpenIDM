...
----
====
For more information about the `JWT_SESSION` module, see the following Javadoc page: link:https://github.com/OpenIdentityPlatform/commons/blob/master/commons/auth-filters/authn-filter/jaspi-modules/jwt-session-module/src/main/java/org/forgerock/jaspi/modules/session/jwt/JwtSessionModule.java[Class JwtSessionModule, window=\_blank].
