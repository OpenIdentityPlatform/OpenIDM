...
public class ServletFilterRegistrator {
    private final static Logger logger = LoggerFactory.getLogger(ServletFilterRegistrator.class);
    ...
    protected synchronized void activate(ComponentContext context) throws Exception {
        ...
        Filter proxiedFilter = (Filter)
                Proxy.newProxyInstance(
                        ...
                        new FilterProxy(filter, filterCL));
