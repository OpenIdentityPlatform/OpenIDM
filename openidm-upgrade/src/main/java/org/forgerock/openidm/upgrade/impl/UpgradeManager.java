...
/**
 * Basic manager to initiate the product
 * upgrade and patching mechanisms. 
...
public class UpgradeManager {
    ...
    public void execute(String urlString, File workingDir, File installDir, 
            Map<String, Object> params) throws InvalidArgsException, UpgradeException {
        ...
        try {
            ...
            throw new UpgradeException("Failed to access the specified file " 
        ...
        try {
            ...
            throw new UpgradeException("Failure during the upgrade/patch execution " + ex.getMessage(), ex);
        }
    }
