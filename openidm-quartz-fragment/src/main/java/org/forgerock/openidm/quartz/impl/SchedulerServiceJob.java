...
public class SchedulerServiceJob implements InterruptableJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            if (scheduledService == null) {
                ...
                // When the Quartz Scheduler shuts down, it will attempt to interrupt all running jobs if they implement InterruptableJob
                // interface. If this occurs prior to the invocation of the targeted service, exit.
                if (interrupted) {
                    logger.info("ScheduledServiceJob targeting service" + invokeService +
                            " not executed because the Quartz Scheduler is shutting down.");
                    return;
                }
