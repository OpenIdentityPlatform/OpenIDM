 ...
 *
 */
public class PrePatchException extends PatchException {
     ...
     */
    public PrePatchException(String message) {
        super(message);
    }
     ...
     */
    public PrePatchException(String message, Throwable ex) {
        super(message, ex);
    }
}
