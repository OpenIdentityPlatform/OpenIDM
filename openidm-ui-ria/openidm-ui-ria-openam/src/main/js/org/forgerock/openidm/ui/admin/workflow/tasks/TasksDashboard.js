...
define("org/forgerock/openidm/ui/admin/workflow/tasks/TasksDashboard", [
    ...
    "org/forgerock/openam/ui/dashboard/DashboardView"
    ...
    var TasksDashboard = AbstractView.extend({
        ...
        render: function(params, args) {
            ...
            this.parentRender(function() {
                ...
                this.appsDashboard.element = "#dashboardWrapper";
                this.appsDashboard.noBaseTemplate = true;
