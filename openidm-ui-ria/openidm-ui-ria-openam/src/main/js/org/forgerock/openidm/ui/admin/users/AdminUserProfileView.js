...
], function(AbstractView, validatorsManager, uiUtils, userDelegate, eventManager, constants, conf, confirmationDialog, router, countryStateDelegate, dashboardDelegate) {
    var AdminUserProfileView = AbstractView.extend({
        ...
        formSubmit: function(event) {
            ...
            if(validatorsManager.formValidated(this.$el)) {
                ...
                data.assignedDashboard = this.$el.find("input[name=assignedDashboard]:checked").map(function(){return $(this).val();}).get();
        ...
        render: function(userName, callback) {
            ...
            userDelegate.getForUserName(userName, _.bind(function(user) {
                ...
                dashboardDelegate.getAvailableApplications(_.bind(function (apps) {
                    this.data.apps = {};
                    _.each(_.pluck(apps, 'dashboardName'), _.bind(function (dashboard) { this.data.apps[dashboard] = dashboard; }, this));
        ...
        reloadData: function() {
            ...
            _.each(this.editedUser.assignedDashboard, _.bind(function(v) {
                this.$el.find("input[name=assignedDashboard][value="+v+"]").attr('checked', true);
            }, this));
