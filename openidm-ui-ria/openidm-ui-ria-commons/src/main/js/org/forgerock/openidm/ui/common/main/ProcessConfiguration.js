 ...
 * @author yaromin
 */
define("org/forgerock/openidm/ui/common/main/ProcessConfiguration", [
    ...
    eventManager.registerListener(constants.EVENT_DEPENDECIES_LOADED, function(event) {
        obj.callService("org/forgerock/openidm/ui/common/main/Configuration","sendConfigurationChangeInfo");
