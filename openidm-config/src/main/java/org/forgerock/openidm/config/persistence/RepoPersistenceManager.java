...
//        authzid.put(SecurityContext.AUTHZID_COMPONENT,RepoPersistenceManager.class.getCanonicalName());
...
//        context = new SecurityContext(new RootContext(), ctx.getProperty(Constants.BUNDLE_SYMBOLICNAME),authzid);
//
//    }
//
//    /**
...
//            java.util.Iterator<Resource> dbIter = null;
