        ...
        final SubResources subResources = SubResources.subresources()
                ...
                .put("/{instanceId}", Resource.resource()
                        ...
                        .create(Create.create()
                                ...
                                .description("Create a single-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .read(Read.read()
                                .description("Read a single-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .update(Update.update()
                                .description("Update a single-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .delete(Delete.delete()
                                .description("Delete a single-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .patch(Patch.patch()
                                .operations(ADD, REMOVE, REPLACE, INCREMENT, COPY, MOVE, TRANSFORM)
                                .description("Patch a single-instance configuration.")
                                .error(notFoundError)
                                .error(badRequestError)
                                .build())
                        .build())
                .put("/{factoryPid}/{instanceId}", Resource.resource()
                        ...
                        .create(Create.create()
                                .mode(CreateMode.ID_FROM_CLIENT)
                                .description("Create a multi-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .read(Read.read()
                                .description("Read a multi-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .update(Update.update()
                                .description("Update a multi-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .delete(Delete.delete()
                                .description("Delete a multi-instance configuration.")
                                .error(notFoundError)
                                .build())
                        .patch(Patch.patch()
                                .operations(ADD, REMOVE, REPLACE, INCREMENT, COPY, MOVE, TRANSFORM)
                                .description("Patch a multi-instance configuration.")
                                .error(notFoundError)
                                .error(badRequestError)
                                .build())
                        .build())
