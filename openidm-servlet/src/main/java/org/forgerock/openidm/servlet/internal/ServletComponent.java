 ...
 */
@org.apache.felix.scr.annotations.Component(name = "org.forgerock.openidm.servlet",
        immediate = true, policy = ConfigurationPolicy.IGNORE)
@Service
@Properties({
    ...
    protected synchronized void activate(ComponentContext context) {
        ...
        serviceRegistration =
                FrameworkUtil.getBundle(ContextRegistrator.class).getBundleContext()
                        .registerService(HttpServlet.class.getName(), servlet, null);
